        ...
        <div className="relative w-28 h-28">
          <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
            ...
            <circle
              ...
              strokeWidth="8"
              strokeLinecap="round"
              strokeDasharray={`${84 * 2.639} ${100 * 2.639}`}
            />
          </svg>
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1.5">
        <div className="flex items-center justify-between">
          ...
          <a
            href="#"
            style={{ fontSize: 13, fontWeight: 500, color: "#6C47FF" }}
        ...
        >
          ...
          >
            {showPassword ? (
              <EyeOff size={18} color="#1A1A2E" opacity={0.4} />
            ) : (
              <Eye size={18} color="#1A1A2E" opacity={0.4} />
            )}
          </button>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <p className="text-center" style={{ fontSize: 12, color: "#1A1A2E", opacity: 0.4, lineHeight: 1.6 }}>
        ...
        <a href="#" style={{ color: "#6C47FF", fontWeight: 500 }} className="hover:underline">
          Terms
        </a>{" "}
        &{" "}
        <a href="#" style={{ color: "#6C47FF", fontWeight: 500 }} className="hover:underline">
      ...
      >
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span style={{ fontSize: 22, fontWeight: 700, color: "#fff", letterSpacing: "-0.01em" }}>
              Clutch
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <p style={{ fontSize: 16, color: "rgba(255,255,255,0.6)", maxWidth: 380, lineHeight: 1.7 }}>
            Join thousands of people who use Clutch to stay ahead of their
      ...
      >
        <div className="w-full max-w-[420px]">
          ...
          <div
            ...
            style={{ borderBottom: "2px solid rgba(108,71,255,0.08)" }}
          >
            {[
          ...
          <div className="mb-8">
            ...
            <p style={{ fontSize: 15, color: "#1A1A2E", opacity: 0.5, marginTop: 6 }}>
              {activeTab === "signin"
                ...
                : "Create your free Clutch account"}
            </p>
          </div>
